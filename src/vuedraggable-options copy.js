...
const draggableComponent = defineComponent({
  ...
  methods: {
    ...
    getUnderlyingPotentialDraggableComponent(htmElement) {
    ...
    onDragStart(evt) {
      if (this.componentStructure.isMultiRootComponent) multiRootComponentOnDragStart(evt);
    ...
    onDragEnd(evt) {
      if (this.componentStructure.isMultiRootComponent) multiRootComponentOnDragEnd(evt);
